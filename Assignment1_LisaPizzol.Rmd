...
```{r data2, echo=TRUE, fig.cap=, message=FALSE, warning=FALSE}
...
```{r data3, echo=TRUE, fig.cap=, message=FALSE, warning=FALSE}
...
```{r data5, echo=TRUE, fig.cap="Average, message=FALSE, warning=FALSE, dpi=150}
...
Table \@ref(tab:data4) indicates that the Northern Hemisphere has slightly warmer global average temperatures when compared to the Southern Hemisphere. This was further supported by the data in Figure \@ref(fig:data5), where it was seen the Northern Hemisphere had an increase of 1.6 degrees while the Southern Hemisphere had an increase of 1.1 degrees over the time period from 1850 to 2023. Figure \@ref(fig:data5), also showed that the average global temperatures have increased by 1.2 degrees in the time period from 1850 to 2023. 
